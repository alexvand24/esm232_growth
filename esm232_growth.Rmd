...
- dC_dt = rate of change of forest size
- cc_threshold (canopy closure threshold) = size of the forest at which growth rates change from exponential to linear (from r to g)


```{r}
# need to move this over to an R script and add roxygen skeleton

# early exponential growth rate
# dC_dt <- r * C for forests where C is below a threshold canopy closure
# parms is a list of r, g, K, cc_threshold
...
```{r}
# set parameters
forestparms <- list(r = 0.01, g = 2, K = 250, C)
